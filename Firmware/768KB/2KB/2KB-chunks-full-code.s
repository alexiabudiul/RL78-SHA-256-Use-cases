...
.Lfunc_end4:
	.size	_sha256_compute, .Lfunc_end4-_sha256_compute
                                        ; -- End function
	.globl	_generate_random_data_for_chunk ; -- Begin function generate_random_data_for_chunk
	.type	_generate_random_data_for_chunk,@function
_generate_random_data_for_chunk:        ; @generate_random_data_for_chunk
; %bb.0:
	subw sp, #4
	movw hl, #0
	clrw bc
...
.LBB5_3:                                ;   in Loop: Header=BB5_1 Depth=1
	...
	xor a, x
	xor a, #85
	mov LOWW(_current_vector_8k)[bc], a
	movw ax, hl
	cmpw ax, #0
	movw ax, bc
	xchw ax, bc
...
.LBB5_4:
	...
	ret
.Lfunc_end5:
	.size	_generate_random_data_for_chunk, .Lfunc_end5-_generate_random_data_for_chunk
                                        ; -- End function
	.globl	_process_current_8kb_vector     ; -- Begin function process_current_8kb_vector
	.type	_process_current_8kb_vector,@function
_process_current_8kb_vector:            ; @process_current_8kb_vector
; %bb.0:
	subw sp, #34
	movw bc, #2048
	movw ax, sp
	movw [sp+32], ax
	movw de, ax
	movw ax, #LOWW(_current_vector_8k)
	call !_sha256_compute
	movw ax, [sp+32]
	movw de, ax
	movw bc, #2048
	movw ax, #LOWW(_current_vector_8k+2048)
	call !_sha256_compute
	movw ax, [sp+32]
	movw de, ax
	movw bc, #2048
	movw ax, #LOWW(_current_vector_8k+4096)
	call !_sha256_compute
	movw ax, [sp+32]
	movw de, ax
	movw bc, #2048
	movw ax, #LOWW(_current_vector_8k+6144)
	call !_sha256_compute
	addw sp, #34
	ret
.Lfunc_end6:
	.size	_process_current_8kb_vector, .Lfunc_end6-_process_current_8kb_vector
                                        ; -- End function
...
_g_sha_state:
	...
	.type	_current_vector_8k,@object      ; @current_vector_8k
	.globl	_current_vector_8k
_current_vector_8k:
	.skip	8192
	.size	_current_vector_8k, 8192

	.type	_g_dummy_sink,@object           ; @g_dummy_sink
	.globl	_g_dummy_sink
_g_dummy_sink:
	.byte	0                               ; 0x0
	.size	_g_dummy_sink, 1
...
_K:
	...
	.addrsig_sym _current_vector_8k
