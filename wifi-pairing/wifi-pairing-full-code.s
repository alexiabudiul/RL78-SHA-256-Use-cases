...
.LBB3_3:
	...
	movw [sp+76], ax
	movw hl, !LOWW(_g_sha_bitcount+2)
	movw bc, !LOWW(_g_sha_bitcount+4)
	movw ax, !LOWW(_g_sha_bitcount+6)
	movw [sp+92], ax
	movw ax, de
	xchw ax, de
...
; %bb.0:
	...
	clrb !LOWW(_k_ipad+8)
	clrb !LOWW(_k_ipad+9)
	clrb !LOWW(_k_ipad+10)
	clrb !LOWW(_k_ipad+11)
	clrb !LOWW(_k_ipad+12)
	clrb !LOWW(_k_ipad+13)
	clrb !LOWW(_k_ipad+14)
	clrb !LOWW(_k_ipad+15)
	clrb !LOWW(_k_ipad+16)
	clrb !LOWW(_k_ipad+17)
	clrb !LOWW(_k_ipad+18)
	clrb !LOWW(_k_ipad+19)
	clrb !LOWW(_k_ipad+20)
	clrb !LOWW(_k_ipad+21)
	clrb !LOWW(_k_ipad+22)
	clrb !LOWW(_k_ipad+23)
	clrb !LOWW(_k_ipad+24)
	clrb !LOWW(_k_ipad+25)
	clrb !LOWW(_k_ipad+26)
	clrb !LOWW(_k_ipad+27)
	clrb !LOWW(_k_ipad+28)
	clrb !LOWW(_k_ipad+29)
	clrb !LOWW(_k_ipad+30)
	clrb !LOWW(_k_ipad+31)
	clrb !LOWW(_k_ipad+32)
	clrb !LOWW(_k_ipad+33)
	clrb !LOWW(_k_ipad+34)
	clrb !LOWW(_k_ipad+35)
	clrb !LOWW(_k_ipad+36)
	clrb !LOWW(_k_ipad+37)
	clrb !LOWW(_k_ipad+38)
	clrb !LOWW(_k_ipad+39)
	clrb !LOWW(_k_ipad+40)
	clrb !LOWW(_k_ipad+41)
	clrb !LOWW(_k_ipad+42)
	clrb !LOWW(_k_ipad+43)
	clrb !LOWW(_k_ipad+44)
	clrb !LOWW(_k_ipad+45)
	clrb !LOWW(_k_ipad+46)
	clrb !LOWW(_k_ipad+47)
	clrb !LOWW(_k_ipad+48)
	clrb !LOWW(_k_ipad+49)
	clrb !LOWW(_k_ipad+50)
	clrb !LOWW(_k_ipad+51)
	clrb !LOWW(_k_ipad+52)
	clrb !LOWW(_k_ipad+53)
	clrb !LOWW(_k_ipad+54)
	clrb !LOWW(_k_ipad+55)
	clrb !LOWW(_k_ipad+56)
	clrb !LOWW(_k_ipad+57)
	clrb !LOWW(_k_ipad+58)
	clrb !LOWW(_k_ipad+59)
	clrb !LOWW(_k_ipad+60)
	clrb !LOWW(_k_ipad+61)
	clrb !LOWW(_k_ipad+62)
	clrb !LOWW(_k_ipad+63)
	clrb !LOWW(_k_opad)
	clrb !LOWW(_k_opad+1)
	clrb !LOWW(_k_opad+2)
	clrb !LOWW(_k_opad+3)
	...
	clrb !LOWW(_k_opad+8)
	clrb !LOWW(_k_opad+9)
	clrb !LOWW(_k_opad+10)
	clrb !LOWW(_k_opad+11)
	clrb !LOWW(_k_opad+12)
	clrb !LOWW(_k_opad+13)
	clrb !LOWW(_k_opad+14)
	clrb !LOWW(_k_opad+15)
	clrb !LOWW(_k_opad+16)
	clrb !LOWW(_k_opad+17)
	clrb !LOWW(_k_opad+18)
	clrb !LOWW(_k_opad+19)
	clrb !LOWW(_k_opad+20)
	clrb !LOWW(_k_opad+21)
	clrb !LOWW(_k_opad+22)
	clrb !LOWW(_k_opad+23)
	clrb !LOWW(_k_opad+24)
	clrb !LOWW(_k_opad+25)
	clrb !LOWW(_k_opad+26)
	clrb !LOWW(_k_opad+27)
	clrb !LOWW(_k_opad+28)
	clrb !LOWW(_k_opad+29)
	clrb !LOWW(_k_opad+30)
	clrb !LOWW(_k_opad+31)
	clrb !LOWW(_k_opad+32)
	clrb !LOWW(_k_opad+33)
	clrb !LOWW(_k_opad+34)
	clrb !LOWW(_k_opad+35)
	clrb !LOWW(_k_opad+36)
	clrb !LOWW(_k_opad+37)
	clrb !LOWW(_k_opad+38)
	clrb !LOWW(_k_opad+39)
	clrb !LOWW(_k_opad+40)
	clrb !LOWW(_k_opad+41)
	clrb !LOWW(_k_opad+42)
	clrb !LOWW(_k_opad+43)
	clrb !LOWW(_k_opad+44)
	clrb !LOWW(_k_opad+45)
	clrb !LOWW(_k_opad+46)
	clrb !LOWW(_k_opad+47)
	clrb !LOWW(_k_opad+48)
	clrb !LOWW(_k_opad+49)
	clrb !LOWW(_k_opad+50)
	clrb !LOWW(_k_opad+51)
	clrb !LOWW(_k_opad+52)
	clrb !LOWW(_k_opad+53)
	clrb !LOWW(_k_opad+54)
	clrb !LOWW(_k_opad+55)
	clrb !LOWW(_k_opad+56)
	clrb !LOWW(_k_opad+57)
	clrb !LOWW(_k_opad+58)
	clrb !LOWW(_k_opad+59)
	clrb !LOWW(_k_opad+60)
	clrb !LOWW(_k_opad+61)
	clrb !LOWW(_k_opad+62)
	clrb !LOWW(_k_opad+63)
	movw ax, bc
	cmpw ax, #0
	sknz ;#.LBB4_10
	br $!.LBB4_10
...
.LBB4_62:
	...
	ret
.Lfunc_end4:
	.size	_hmac_sha256, .Lfunc_end4-_hmac_sha256
                                        ; -- End function
	.globl	_run_wifi_pairing_benchmark     ; -- Begin function run_wifi_pairing_benchmark
	.type	_run_wifi_pairing_benchmark,@function
_run_wifi_pairing_benchmark:            ; @run_wifi_pairing_benchmark
; %bb.0:
	subw sp, #44
	mov !LOWW(_g_wifi_ssid+31), #31
	mov !LOWW(_g_wifi_ssid+30), #30
	mov !LOWW(_g_wifi_ssid+29), #29
	mov !LOWW(_g_wifi_ssid+28), #28
	mov !LOWW(_g_wifi_ssid+27), #27
	mov !LOWW(_g_wifi_ssid+26), #26
	mov !LOWW(_g_wifi_ssid+25), #25
	mov !LOWW(_g_wifi_ssid+24), #24
	mov !LOWW(_g_wifi_ssid+23), #23
	mov !LOWW(_g_wifi_ssid+22), #22
	mov !LOWW(_g_wifi_ssid+21), #21
	mov !LOWW(_g_wifi_ssid+20), #20
	mov !LOWW(_g_wifi_ssid+19), #19
	mov !LOWW(_g_wifi_ssid+18), #18
	mov !LOWW(_g_wifi_ssid+17), #17
	mov !LOWW(_g_wifi_ssid+16), #16
	mov !LOWW(_g_wifi_ssid+15), #15
	mov !LOWW(_g_wifi_ssid+14), #14
	mov !LOWW(_g_wifi_ssid+13), #13
	mov !LOWW(_g_wifi_ssid+12), #12
	mov !LOWW(_g_wifi_ssid+11), #11
	mov !LOWW(_g_wifi_ssid+10), #10
	mov !LOWW(_g_wifi_ssid+9), #9
	mov !LOWW(_g_wifi_ssid+8), #8
	mov !LOWW(_g_wifi_ssid+7), #7
	mov !LOWW(_g_wifi_ssid+6), #6
	mov !LOWW(_g_wifi_ssid+5), #5
	mov !LOWW(_g_wifi_ssid+4), #4
	mov !LOWW(_g_wifi_ssid+3), #3
	mov !LOWW(_g_wifi_ssid+2), #2
	oneb !LOWW(_g_wifi_ssid+1)
	clrb !LOWW(_g_wifi_ssid)
	movw de, #LOWW(_g_wifi_ssid)
	movw bc, #16
	movw ax, sp
	addw ax, #4
	movw [sp+2], ax
	movw ax, #32
	movw [sp+0], ax
	movw ax, #LOWW(L___const.run_wifi_pairing_benchmark.password)
	call !_hmac_sha256
	onew bc
	clrw ax
	movw [sp+42], ax
...
.LBB5_4:
	...
	ret
.Lfunc_end5:
	.size	_run_wifi_pairing_benchmark, .Lfunc_end5-_run_wifi_pairing_benchmark
                                        ; -- End function
...
_k_opad:
	...
	.type	L___const.run_wifi_pairing_benchmark.password,@object ; @__const.run_wifi_pairing_benchmark.password
	.section	.rodata.cst16,"aM",@progbits,16
L___const.run_wifi_pairing_benchmark.password:
	.ascii	"MySecretWiFiPass"
	.size	L___const.run_wifi_pairing_benchmark.password, 16

	.type	_g_wifi_ssid,@object            ; @g_wifi_ssid
	.section	.bss,"aw",@nobits
	.globl	_g_wifi_ssid
_g_wifi_ssid:
	.skip	32
	.size	_g_wifi_ssid, 32

	.type	_g_temp_digest,@object          ; @g_temp_digest
	.globl	_g_temp_digest
_g_temp_digest:
	.skip	32
	.size	_g_temp_digest, 32
...
_K:
	...
	.addrsig_sym _k_ipad
	.addrsig_sym _k_opad
	.addrsig_sym _g_wifi_ssid
	.addrsig_sym _g_temp_digest
